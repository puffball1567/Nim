...
function chckRange(i_p0, a_p1, b_p2) {
  var result_33557418 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557418 = i_p0;
    break BeforeRet;
    }
    else {
    raiseRangeError();
...
function nimMax(a_p0, b_p1) {
  ...
  BeforeRet: {
    ...
    result_33557205 = Temporary1;
    break BeforeRet;
  };

  return result_33557205;
...
function newSeq__system_u2564(len_p0) {
  var result_33557000 = [];
    ...
    result_33557000 = new Array(len_p0); for (var i = 0 ; i < len_p0 ; ++i) { result_33557000[i] = null; }
